    ...
    questions: [
      {
        ...
        a: "LoudReader uses Apple's on-device AI to generate natural-sounding narration in real time. Everything happens locally on your iPhone or iPad — no data is sent anywhere.",
      },
      {
